...
function getSplitPanelContent(context, webview, content, fileName) {
    ...
    // Use context.extensionPath to get the correct path to the extension root
    // const htmlPath = path.join(context.extensionPath, 'src', 'webview_template/webview_old', 'index.html');
    // const cssPath = path.join(context.extensionPath, 'src', 'webview_template/webview_old', 'index.css');
    // const jsPath = path.join(context.extensionPath, 'src', 'webview_template/webview_old', 'index.js');
    // Read HTML content
    ...
    //     .replace('{{FILENAME}}', fileName.split('/').pop() || '')
