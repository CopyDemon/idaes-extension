...
function reloadCurrentWebview() {
    if (currentPanel && currentContext) {
        ...
        if (editor) {
            currentPanel.webview.html = (0, get_webview_template_1.getSplitPanelContent)(currentContext, currentPanel.webview, editor.document.getText(), editor.document.fileName);
